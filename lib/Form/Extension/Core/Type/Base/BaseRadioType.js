...
class BaseRadionType extends BaseType {
        ...
        this.addOption('value', options.value, {
            ...
            rules: {
                ...
                Callback: {
                    ...
                    'parameters': {},
                    'message': `Expected type \"string\" or \"object\" in format: \"{'key': 'EUR', 'value': 'Euro'}\"`
                }
            }
        });
    }
    ...
    // Rendering -----------------------------------------------------------------------------------
    createField() {
        let _checkType = (this.state.value == this.getOptionValue()) ? 'radio-button-checked' : 'radio-button-unchecked';
